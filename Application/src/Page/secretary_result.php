...
<header>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            fetch('../database/Secretary/secretary_read_result_action.php')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(results => {
                    ...
                    if (results.length > 0) {
                        let table = '<table><tr><th>ResultID</th><th>OrderID</th><th>Report URL</th><th>Interpretation</th><th>Result Date and Time</th><th>Result Status</th><th>Patient</th><th>Lab Staff</th></tr>';
